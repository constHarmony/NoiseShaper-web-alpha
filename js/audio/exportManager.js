...
class ExportManager extends EventTarget {
    ...
    getDefaultSettings() {
        return {
            // Audio Generation
            duration: 10.0, // 10ms default for critical fade processing
            clips: 40, // 40 clips as requested
            silenceEnabled: true, // enabled by default
            silenceDuration: 190.0, // milliseconds
